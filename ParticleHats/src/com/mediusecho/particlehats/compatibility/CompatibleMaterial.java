...
public enum CompatibleMaterial {
	...
	CONDUIT ("CLAY_BALL", 0),
	COPPER_BLOCK ("STONE", 0),
	CRIMSON_FUNGUS ("MUSHROOM", 0),
	CRYING_OBSIDIAN ("OBSIDIAN", 0),
	CYAN_CANDLE ("STONE", 0),
	CYAN_DYE ("INK_SACK", 6),
	CYAN_STAINED_GLASS_PANE ("STAINED_GLASS_PANE", 9),
	
	DANDELION (0, "FLOWER", "DANDELION"),
	DRAGON_HEAD ("SKULL_ITEM", 5),
	DRIPSTONE_BLOCK ("STONE", 0),
	...
	HONEYCOMB (0, "HONEYCOMB", "POTION"),
	HONEY_BOTTLE (0, "HONEY_BOTTLE", "POTION"),
	...
	SOUL_CAMPFIRE (0, "CAMPFIRE", "TORCH"),
	SOUL_LANTERN (0, "LANTERN", "TORCH"),
	SPLASH_POTION ("POTION", 0),
	SPORE_BLOSSOM ("STONE", 0),
	SUNFLOWER ("DOUBLE_PLANT", 0),
	
	TOTEM_OF_UNDYING ("TOTEM", 0),
	TURTLE_HELMET ("LEATHER_HELMET", 0),
	
	WARPED_FUNGUS ("BROWN_MUSHROOM", 0),
	WEATHERED_COPPER ("STONE", 0),
	WHEAT_SEEDS ("SEEDS", 0),
